...
writeFileSync(args[args.indexOf('-o')+1],JSON.stringify({verdict:'pass',reasons:[],briefing:{summary:'Review completed.',decisions:[]},findings:[],coverage:{invariants:[],scan:[],not_reviewed:[]}}));
`, { mode: 0o700 });
    const loader = join(dir, 'mock.mjs');
...
writeFileSync(args[args.indexOf('-o')+1],JSON.stringify({verdict:'pass',reasons:[],briefing:{summary:'Review of PR '+number,decisions:[]},findings:[],coverage:{invariants:[],scan:[],not_reviewed:[]}}));
`, { mode: 0o700 });
    const loader = join(dir, 'mock.mjs');
